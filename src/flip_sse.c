...
/* static const unsigned long long FLIPPED_0_V[33] = {
	0x0000000000000000, 0x000000000000ff00, 0x0000000000ffff00, 0x0000000000000000, 0x00000000ffffff00, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
	0x000000ffffffff00, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
	0x0000ffffffffff00, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
	0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
	0x00ffffffffffff00
}; */
...
static const unsigned long long FLIPPED_7_V[33] = {
...
static __m128i vectorcall flip_D1(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_3[(_mm_extract_epi16(OP, 4) >> 1) & 0x3f] & _mm_cvtsi128_si64(OP);
...
static __m128i vectorcall flip_E1(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_4[(_mm_extract_epi16(OP, 4) >> 1) & 0x3f] & _mm_cvtsi128_si64(OP);
...
static __m128i vectorcall flip_D2(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_3[(_mm_extract_epi16(OP, 4) >> 9) & 0x3f] & (_mm_cvtsi128_si64(OP) >> 8);
...
static __m128i vectorcall flip_E2(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_4[(_mm_extract_epi16(OP, 4) >> 9) & 0x3f] & (_mm_cvtsi128_si64(OP) >> 8);
...
static __m128i vectorcall flip_D3(const __m128i OP)
{
	...
	outflank_v = OUTFLANK_2[(index_v >> 9) & 0x3f] & index_v;
	...
	outflank_h = OUTFLANK_3[(_mm_extract_epi16(OP, 5) >> 1) & 0x3f] & _mm_extract_epi16(OP, 1);
...
static __m128i vectorcall flip_E3(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_4[(_mm_extract_epi16(OP, 5) >> 1) & 0x3f] & _mm_extract_epi16(OP, 1);
...
static __m128i vectorcall flip_D6(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_3[(_mm_extract_epi16(OP, 6) >> 9) & 0x3f] & (_mm_extract_epi16(OP, 2) >> 8);
...
static __m128i vectorcall flip_E6(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_4[(_mm_extract_epi16(OP, 6) >> 9) & 0x3f] & (_mm_extract_epi16(OP, 2) >> 8);
...
static __m128i vectorcall flip_D7(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_3[(_mm_extract_epi16(OP, 7) >> 1) & 0x3f] & _mm_extract_epi16(OP, 3);
...
static __m128i vectorcall flip_E7(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_4[(_mm_extract_epi16(OP, 7) >> 1) & 0x3f] & _mm_extract_epi16(OP, 3);
...
static __m128i vectorcall flip_D8(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_3[(_mm_extract_epi16(OP, 7) >> 9) & 0x3f] & (_mm_extract_epi16(OP, 3) >> 8);
...
static __m128i vectorcall flip_E8(const __m128i OP)
{
	...
	outflank_h = OUTFLANK_4[(_mm_extract_epi16(OP, 7) >> 9) & 0x3f] & (_mm_extract_epi16(OP, 3) >> 8);
